...
<template>
  <header class="h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-40">
    <div class="h-full flex items-center justify-between px-6">
      ...
      <div class="flex items-center gap-4">
        ...
        <span class="text-[11px] font-semibold px-2 py-0.5 rounded-full bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400">
          ADMIN
        </span>
        <button
