...
<template>
  <div class="max-w-3xl mx-auto">
    ...
    <div
      v-if="decksStore.detailLoading && !decksStore.currentDeck"
    ...
    <div
      v-else-if="decksStore.detailError && !decksStore.currentDeck"
    ...
    <template v-else-if="decksStore.currentDeck">
      ...
      <div v-if="decksStore.detailError" class="mb-4 text-sm text-red-500">
        {{ decksStore.detailError }}
      </div>

      <div
        v-if="!decksStore.currentDeck.words.length"
